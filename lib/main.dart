...
import 'pages/agent/2_agent_home.dart';
import 'pages/agent/3_news_updates.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // home: const UserHome(), // PAGE 4, home
      ...
      // home: const AgentHome(), // PAGE 15, Agent Dashboard
      // home: const NewsAndUpdates(), // PAGE 16, News and Updates Final
    );
  }
}
